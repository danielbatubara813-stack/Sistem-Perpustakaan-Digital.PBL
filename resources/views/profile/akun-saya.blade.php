    ...
    <div class="w-full flex flex-col gap-4 p-4 space-y-4">
        ...
        <form action="{{ route('profile.akun-saya.change-password') }}" method="POST" class="grid grid-cols-2 gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                    <input id="kata_sandi_baru" name="password" type="password" placeholder="Kata Sandi Baru..."
                    ...
                    <button type="button" onmousedown="showPassword('kata_sandi_baru', this)"
                        onmouseup="hidePassword('kata_sandi_baru', this)"
                        onmouseleave="hidePassword('kata_sandi_baru', this)"
                        ontouchstart="showPassword('kata_sandi_baru', this)"
                        ontouchend="hidePassword('kata_sandi_baru', this)"
            ...
            <div class="flex flex-col gap-2">
                <label for="konfirm_kata_sandi">Konfirmasi Kata Sandi Baru</label>
                <div class="relative">
            ...
            <div class="col-span-2 flex justify-end items-center gap-4">
                <button type="reset"
                    class="bg-slate-500 py-2 w-max px-6 rounded-md text-white flex gap-4 items-center justify-center hover:bg-slate-600 ease-in-out transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
