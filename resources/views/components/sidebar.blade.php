...
<div id="sidebar"
    ...
    <div class="relative w-full h-full flex flex-col">
        ...
        <div class="flex items-center gap-3 p-5 pb-4">
            ...
            <div>
                <h1 class="poppins font-bold text-base tracking-wide uppercase leading-tight">Libratech</h1>
                <p class="poppins text-xs text-gray-500">Perpustakaan Digital</p>
            </div>
        </div>
            ...
            <ul class="space-y-1 text-sm">
                ...
                <li>
                    <a href="{{ route('admin.anggota.daftar') }}"
                        ...
                        <span class="relative z-10 ml-auto w-2.5 h-2.5 bg-red-500 rounded-full animate-pulse"></span>
                    @endif
                    </a>
                </li>
                <li>
                ...
                <li>
                    <button data-modal-target="export-modal" data-modal-toggle="export-modal" type="button"
                        class="w-full flex gap-3 text-gray-700 items-center rounded-lg px-3 py-2.5 relative group overflow-hidden hover:text-white transition-all duration-300 cursor-pointer">
                        <span
                            class="absolute inset-0 w-0 bg-blue-800 group-hover:w-full transition-all duration-300 ease-in-out z-0"></span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="relative z-10" width="18" height="18"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
