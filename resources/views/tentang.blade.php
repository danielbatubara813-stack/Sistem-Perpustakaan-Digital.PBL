...
@section('content')
    ...
    <div class="bg-white px-6 md:px-16 py-16 space-y-16">
        ...
        <div class="grid md:grid-cols-2 gap-10 items-center">
            ...
            {{-- image --}}
            <img src="https://deepublishstore.com/wp-content/uploads/2021/10/prospek-kerja-jurusan-ilmu-perpustakaan.jpg"
    ...
    <div class="bg-blue-800 ">
        <div class="px-6 md:px-16 py-16 space-y-16 max-w-6xl mx-auto">
            <div class="text-center">
                <h2 class="font-bold mb-8 text-white text-3xl">VISI MISI TUJUAN</h2>
    ...
    <div class="bg-white">
        <div class="px-6 md:px-16 py-16 space-y-16 max-w-6xl mx-auto">
            <div class="text-center">
                <h2 class="font-bold mb-8 text-4xl">STATISTIK KOLEKSI PERPUSTAKAAN</h2>

                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">

                    <div
                        class="bg-white border border-gray-300 p-6 rounded-lg shadow text-left hover:shadow-md transition-all duration-300 hover:-translate-y-1">
