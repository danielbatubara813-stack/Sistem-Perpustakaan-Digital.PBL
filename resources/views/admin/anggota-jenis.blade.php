...
@section('content')
    <div class="p-6 poppins">
        <div class="bg-white rounded-lg p-4 mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-bold uppercase tracking-wide">Daftar Keanggotaan</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola jenis keanggotaan untuk pembatasan akses</p>
            </div>
            ...
            <div class="mb-4 flex items-center justify-between">
                <div class="bg-slate-100 rounded-md px-2 py-1 flex items-center gap-2">
                    <a id="daftarTab" href="{{ route('admin.anggota') }}"
                        class="px-4 py-2 text-sm {{ request()->routeIs('admin.anggota') ? 'bg-blue-600 text-white shadow rounded' : 'text-slate-600' }}">Daftar
