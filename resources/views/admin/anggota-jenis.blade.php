    ...
    <div class="p-6 poppins">
        ...
        <div class="bg-white p-6 rounded-lg mt-4 shadow-lg">
            <div class="mb-4 flex items-center justify-between">
                ...
                <div>
                    <a href="{{ route('admin.anggota.jenis.create') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md px-3 py-2 text-sm shadow-sm transition">
            ...
            <div class="grid gap-3 grid-cols-1 items-end mb-6">
                <div class="xl:col-span-3">
                    <div class="bg-slate-100 rounded-md p-2 flex flex-wrap items-center gap-2">
                        <input id="search" type="text" placeholder="Cari..." class="flex-1 min-w-[160px] rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                        ...
                        @foreach($types as $type)
                            <tr class="hover:bg-gray-100 transition-all duration-150 ease-in-out odd:bg-white even:bg-slate-100">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="#" class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-transparent text-slate-700 hover:bg-slate-100 transition" aria-label="Edit">
            ...
            <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p class="text-sm text-slate-500">Menampilkan 1 hingga {{ count($types) }} dari {{ count($types) }} data</p>
