                            ...
                            <tr class="odd:bg-white even:bg-slate-100 hover:bg-slate-50 transition-all duration-150">
                                ...
                                <td class="px-3 py-3">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            <p class="font-semibold text-slate-900 line-clamp-1">{{ $book['title'] }}</p>
                                ...
                                <td class="px-3 py-3 text-right">
                                    <div class="inline-flex items-center gap-2 justify-end">
                                        <button
                                            class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-green-600 text-white hover:bg-green-700 transition"
                                            aria-label="Edit">
