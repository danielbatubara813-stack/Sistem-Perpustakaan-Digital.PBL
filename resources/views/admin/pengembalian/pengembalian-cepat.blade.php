                            ...
                            <td class="px-4 sm:px-6 py-4 font-medium text-gray-900">
                                ...
                                <div class="flex items-start gap-4 min-w-70">
                                    ...
                                    <div class="flex items-center gap-4 min-w-70">
                                        ...
                                        Storage::disk('public')->exists('covers/' . $peminjaman->itemBuku->buku->cover_buku)
                                            ? asset('storage/covers/' . $peminjaman->itemBuku->buku->cover_buku)
                ...
                <div class="mt-6 border border-slate-200 rounded-md p-4 shadow-sm bg-slate-50">
                    ...
                    <div class="flex flex-col lg:flex-row gap-6 lg:items-center">
                        ...
                        <img class="w-28 h-28 rounded-xl object-cover object-top shadow-md"
                            src="{{ $peminjaman->anggota->profile && Storage::disk('public')->exists($peminjaman->anggota->profile)
                                ? asset('storage/' . $peminjaman->anggota->profile)
                                : asset('static/profileDefault.jpg') }}"
                            alt="{{ $peminjaman->anggota->nama }}">
