    ...
    <div class="p-6 poppins">
            ...
            <form method="POST" action="{{ route('admin.anggota.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-4 items-start">
                    ...
                    <div class="sm:col-span-9">
                        <input name="email" value="{{ old('email') }}" type="email" placeholder="" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                        @error('email') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <label class="sm:col-span-3 text-sm text-slate-700">Nomor Identitas*</label>
                    <div class="sm:col-span-9">
                        <input name="identity_number" value="{{ old('identity_number') }}" type="text" placeholder="" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                    ...
                    <div class="sm:col-span-9 flex items-center gap-6">
                        <label class="inline-flex items-center gap-2"><input type="radio" name="identity_type" value="NIM" {{ old('identity_type','NIM')=='NIM' ? 'checked' : '' }} class="h-4 w-4 text-blue-600" /> NIM</label>
                        <label class="inline-flex items-center gap-2"><input type="radio" name="identity_type" value="NIDN" {{ old('identity_type')=='NIDN' ? 'checked' : '' }} class="h-4 w-4 text-blue-600" /> NIDN</label>
                    ...
                    <div class="sm:col-span-9">
                        <input name="name" value="{{ old('name') }}" type="text" placeholder="Nama lengkap" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                        @error('name') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <label class="sm:col-span-3 text-sm text-slate-700">Instansi*</label>
                    <div class="sm:col-span-9">
                        <input name="institution" value="{{ old('institution') }}" type="text" placeholder="" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                    ...
                    <div class="sm:col-span-9">
                        <input name="birth_date" value="{{ old('birth_date') }}" type="date" class="rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                    ...
                    <div class="sm:col-span-9">
                        <input name="registration_date" value="{{ old('registration_date') }}" type="date" class="rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                    ...
                    <div class="sm:col-span-9">
                        <select id="membership_type" name="membership_type" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200">
                            <option value="">Pilih tipe keanggotaan</option>
                            <option value="Mahasiswa" {{ old('membership_type')=='Mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                            <option value="Dosen Tetap" {{ old('membership_type')=='Dosen Tetap' ? 'selected' : '' }}>Dosen Tetap</option>
                            <option value="Dosen Magang" {{ old('membership_type')=='Dosen Magang' ? 'selected' : '' }}>Dosen Magang</option>
                        </select>
                    ...
                    <div class="sm:col-span-9 flex items-center gap-6">
                        <label class="inline-flex items-center gap-2"><input type="radio" name="gender" value="L" {{ old('gender','L')=='L' ? 'checked' : '' }} class="h-4 w-4 text-blue-600" /> Laki-laki</label>
                        <label class="inline-flex items-center gap-2"><input type="radio" name="gender" value="P" {{ old('gender')=='P' ? 'checked' : '' }} class="h-4 w-4 text-blue-600" /> Perempuan</label>
                    ...
                    <div class="sm:col-span-9">
                        <input name="phone" value="{{ old('phone') }}" type="tel" placeholder="" class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-200" />
                    ...
                    <div class="sm:col-span-9">
                        <div class="flex flex-col md:flex-row gap-4 items-start">
                            <div class="w-48 h-36 border border-dashed border-slate-300 rounded-md flex items-center justify-center overflow-hidden bg-slate-50">
                                <img id="ktpPreview" src="" alt="KTP preview" class="object-contain w-full h-full hidden" />
                    ...
                    <div class="sm:col-span-9">
                        <div class="flex flex-col md:flex-row gap-4 items-start">
                            <div class="w-48 h-36 border border-dashed border-slate-300 rounded-md flex items-center justify-center overflow-hidden bg-slate-50">
                                <img id="profilePreview" src="" alt="Profile preview" class="object-contain w-full h-full hidden" />
                ...
                <div class="mt-6 flex justify-end gap-3">
                    <button type="submit" name="action" value="verify" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md px-4 py-2 text-sm shadow-sm transition">Verifikasi</button>
                    <button type="submit" name="action" value="reject" class="inline-flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-slate-700 rounded-md px-4 py-2 text-sm shadow-sm transition">Tolak</button>
                    <a href="{{ route('admin.anggota') }}" class="inline-flex items-center gap-2 bg-white border border-slate-300 text-slate-700 rounded-md px-4 py-2 text-sm shadow-sm transition">Batal</a>
                </div>
            </form>
        </div>
    </div>
        ...
        (function(){
            ...
            function updateDaftarLabel() {
                ...
                if (!membershipSelect) { daftarLabel.textContent = ''; return; }
