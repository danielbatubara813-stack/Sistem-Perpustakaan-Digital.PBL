...
@section('content')
    ...
    <form action="{{ route('admin.data-terkendali.penulis.destroy') }}" id="multi-delete-form" data-delete-name="id_penulis"
        method="POST">
        @method('DELETE')
        @csrf
        <div class="bg-white p-6 rounded-lg mt-4 shadow-lg">
                ...
                @if (count($penulis) > 10)
                    <div class="inline-flex items-center gap-2">
                        <div class="px-4 py-2 rounded-md text-sm text-slate-700">
                            ...
                            dari
                            <span class="font-semibold">{{ $penulis->lastPage() }}</span>
                        </div>
