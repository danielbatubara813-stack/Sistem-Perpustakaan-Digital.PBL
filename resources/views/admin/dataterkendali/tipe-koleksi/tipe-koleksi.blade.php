                ...
                <tbody>
                    @foreach ($tipe_koleksi as $type)
                        <tr
                            ...
                            <td class="px-6 py-4 font-medium text-gray-900">{{ $type['nama'] }}</td>
                            <td class="px-6 py-4 hidden lg:table-cell">{{ $type['created_at'] }}</td>
                            <td class="px-6 py-4 hidden lg:table-cell">{{ $type['updated_at'] }}</td>
