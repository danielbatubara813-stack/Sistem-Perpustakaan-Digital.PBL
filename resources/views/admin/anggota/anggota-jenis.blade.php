...
@section('title', 'Kelola Jenis Keanggotaan')
@php
...
@section('content')
    <div class="bg-white p-6 rounded-lg mt-4 shadow-lg">
        <div class="flex flex-col gap-4">
            ...
            {{-- Filter Form --}}
            <form method="GET" action="{{ route('admin.anggota.jenis') }}" id="filterForm">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="bg-slate-100 rounded-md p-2 flex flex-wrap items-center gap-2 w-full md:w-max">
                        <input
                            ...
                            placeholder="Cari jenis keanggotaan..."
    ...
    <div class="bg-white p-6 rounded-lg mt-4 shadow-lg">
        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-lg font-semibold tracking-wide">{{ count($types) }} Daftar jenis anggota</h2>
            </div>
                ...
                <tbody>
                    @forelse ($types as $type)
                        <tr class="hover:bg-gray-100 transition-all duration-150 ease-in-out odd:bg-white even:bg-slate-100">
                            ...
                            <td class="px-6 py-4 font-medium text-gray-900">{{ $type->nama_jenis }}</td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.anggota.jenis.edit', $type->id_jenis) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                Tidak ada data jenis keanggotaan
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p class="text-sm text-slate-500">Menampilkan 1 hingga {{ count($types) }} dari {{ count($types) }} data
            </p>
        </div>
    </div>
