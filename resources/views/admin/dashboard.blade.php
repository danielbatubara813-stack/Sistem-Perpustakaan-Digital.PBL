...
@section('content')
    <div class="p-6 poppins">
        <div class="bg-white rounded-lg p-4 mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-bold uppercase tracking-wide">Dashboard</h1>
                <p class="text-sm text-gray-500 mt-1">Monitoring untuk menampilkan ringkasan data, aktivitas, dan informasi
                    penting secara cepat</p>
            </div>
