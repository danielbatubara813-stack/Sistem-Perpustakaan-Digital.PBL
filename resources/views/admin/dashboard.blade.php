                    ...
                    <tr class="hover:bg-gray-100 transition-all duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4">
                            <span
                                ...
                                <span class="bg-green-600 rounded-full text-white w-6 h-6 flex items-center justify-center">
                    ...
                    <tr class="hover:bg-gray-100 transition-all duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4">
                            <span
                                ...
                                <span class="bg-blue-600 rounded-full text-white w-6 h-6 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-check-icon lucide-check">
                    ...
                    <tr class="hover:bg-gray-100 transition-all duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4">
                            <span
                                ...
                                <span class="bg-red-600 rounded-full text-white w-6 h-6 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
