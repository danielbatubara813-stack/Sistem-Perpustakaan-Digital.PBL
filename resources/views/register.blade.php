    ...
    <div class="flex flex-col items-center w-full min-h-full justify-center py-4">
        ...
        <form method="POST" action="/register" enctype="multipart/form-data"
            ...
            <div class="space-y-2 text-start">
                ...
                <input type="text" name="identity_number" placeholder="Nomor Identitas"
                    autocomplete="off"
            ...
            <div class="space-y-2 text-start">
                ...
                <div class="flex flex-col md:flex-row gap-4 items-start">
                    <div class="w-48 h-36 border border-dashed border-gray-400 rounded-[10px] flex items-center justify-center overflow-hidden bg-gray-50">
                    ...
                    <div class="flex-1">
                        <input id="ktpInput" type="file" name="ktp_photo" accept=".jpg,.jpeg,.png,image/jpeg,image/png" class="text-sm" />
                        @error('ktp_photo')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="space-y-2 text-start">
                ...
                <div class="flex flex-col md:flex-row gap-4 items-start">
                    ...
                    <div class="flex-1">
                        <input id="profileInput" type="file" name="profile_photo" accept=".jpg,.jpeg,.png,image/jpeg,image/png" class="text-sm" />
                        @error('profile_photo')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 mt-1">Maks 10 MB. Format: jpg, jpeg, png.</p>
