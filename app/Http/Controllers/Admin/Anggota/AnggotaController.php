...
class AnggotaController extends Controller
{
    ...
    public function updateAnggota(Request $request, $id)
    {
        ...
        if ($request->verifikasi_admin === 'Terverifikasi') {
            $updateData['status_anggota'] = 'Aktif';
        } elseif ($request->verifikasi_admin === 'Ditolak') {
            $updateData['status_anggota'] = 'Tidak Aktif';
        } else {
            $updateData['status_anggota'] = $request->status_anggota ?? $anggota->status_anggota;
        }
